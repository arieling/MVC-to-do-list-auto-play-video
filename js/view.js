...
(function (window) {
    ...
    function View(template) {
        ...
        this.$removeAllCompleted = qs('#clear-completed');
    }


    View.prototype._selected = function (id, completed) {
    ...
    View.prototype.render = function (viewCmd, parameter) {
        ...
        var viewCommands = {
            ...
            selected: function () {
                that._selected(parameter.id, parameter.completed);
            }
    ...
    View.prototype.bind = function (event, handler) {
        ...
        //bind for removeCompleted
        else if (event === 'removeCompleted') {
            $on(that.$removeAllCompleted, 'click', function () {
                handler();
            });
        }
        //bind for select
        else if (event === 'select') {
            $live('#todo-list .check' ,'click', function () {
                handler({
                    id: that._itemId(this),completed: this.checked
                });
            });
    }
    };
